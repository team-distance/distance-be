...
import static io.festival.distance.domain.admin.adminfestival.foodtruck.exception.FoodTruckErrorCode.NOT_EXIST_FOOD_TRUCK;
...
import io.festival.distance.domain.admin.adminfestival.foodtruck.exception.FoodTruckException;
...
public class FoodTruckService {
    ...
    public FoodTruck findFoodTruck(Long truckId) {
        return foodTruckRepository.findById(truckId)
            .orElseThrow(() -> new FoodTruckException(NOT_EXIST_FOOD_TRUCK));
    }
